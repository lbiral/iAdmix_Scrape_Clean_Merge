...
c.write('# YRI: Yoruba People of Ibadan, Nigeria (HapMap3 population)\n')
c.write('# MKK: Maasai in Kinyawa, Kenya (HapMap3 population)\n')
c.write('# LWK: Luhya in Webuye, Kenya (HapMap3 population)\n')
...
c.write('# CHB: Han Chinese in Beijing, China (HapMap3 population)\n')
c.write('# CHD: Chinese in Metropolitan Denver, Colorado, USA (HapMap3 population)\n')
c.write('# JPT: Japanese in Tokyo, Japan (HapMap3 population)\n')
